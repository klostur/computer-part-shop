...
/* harmony import */ var _security_authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./security/authentication.service */ "./src/app/security/authentication.service.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_security_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _security_authentication_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./security/authentication.service */ "./src/app/security/authentication.service.ts");
/* harmony import */ var _security_can_activate_auth_guard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./security/can-activate-auth.guard */ "./src/app/security/can-activate-auth.guard.ts");
/* harmony import */ var _security_jwt_utils_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./security/jwt-utils.service */ "./src/app/security/jwt-utils.service.ts");
...
var routes = [
    { path: 'main', component: _main_component_main_component_component__WEBPACK_IMPORTED_MODULE_6__["MainComponentComponent"], canActivate: [_security_can_activate_auth_guard__WEBPACK_IMPORTED_MODULE_9__["CanActivateAuthGuard"]] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _security_authentication_service__WEBPACK_IMPORTED_MODULE_8__["AuthenticationService"],
                _security_can_activate_auth_guard__WEBPACK_IMPORTED_MODULE_9__["CanActivateAuthGuard"],
                _security_jwt_utils_service__WEBPACK_IMPORTED_MODULE_10__["JwtUtilsService"]
            ],
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21haW4tY29tcG9uZW50L21haW4tY29tcG9uZW50LmNvbXBvbmVudC5jc3MifQ== */"
...
/* harmony import */ var app_security_authentication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/security/authentication.service */ "./src/app/security/authentication.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainComponentComponent = /** @class */ (function () {
    function MainComponentComponent(http, authenticationService) {
        this.http = http;
        this.authenticationService = authenticationService;
        this.indexPage = 0;
        this.totalList = 0;
    ...
    MainComponentComponent.prototype.getNumberOfPages = function () {
        var _this = this;
        this.http.get("api/computer-parts?size=" + this.size, { observe: 'response' }).subscribe(function (data) {
            _this.totalList = parseInt(data.headers.get('X-Total-Pages'));
        });
    };
    MainComponentComponent.prototype.loadData = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set('page', this.indexPage.toString())
            .set('size', this.size.toString());
        this.http.get("api/computer-parts", { params: params }).subscribe(function (data) {
            _this.computerParts = data;
            _this.reset();
        });
        this.http.get("api/brands").subscribe(function (data) {
            _this.brands = data;
        });
    };
    MainComponentComponent.prototype.hasRole = function (role) {
    ...
    MainComponentComponent.prototype.save = function () {
        ...
        if (this.computerPart.id === undefined) {
            ...
            this.http
                .put("api/computer-parts/" + this.computerPart.id, JSON.stringify(this.computerPart), { headers: headers })
                .subscribe(function (data) {
                _this.loadData();
            });
        }
    };
    MainComponentComponent.prototype.remove = function (i) {
        var _this = this;
        this.http.delete("api/computer-parts/" + i).subscribe(function () {
            _this.loadData();
        });
    };
    MainComponentComponent.prototype.edit = function (c) {
        this.computerPart = c;
    };
    MainComponentComponent.prototype.buy = function (c) {
        var _this = this;
        this.computerPart = c;
        setTimeout(function () { _this.reset(); }, 10);
    };
    MainComponentComponent.prototype.reset = function () {
        this.computerPart = {
            brand: {},
            name: "",
            price: 0
    ...
    MainComponentComponent.prototype.up = function () {
        if (this.indexPage < this.totalList) {
            this.loadData();
            this.indexPage++;
        }
    };
    MainComponentComponent.prototype.down = function () {
        this.indexPage--;
        this.loadData();
    };
    MainComponentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            app_security_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]])
...
/* harmony import */ var app_security_jwt_utils_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/security/jwt-utils.service */ "./src/app/security/jwt-utils.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], app_security_jwt_utils_service__WEBPACK_IMPORTED_MODULE_3__["JwtUtilsService"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var app_security_authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/security/authentication.service */ "./src/app/security/authentication.service.ts");
...
var CanActivateAuthGuard = /** @class */ (function () {
    ...
    CanActivateAuthGuard = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [app_security_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
...
var TokenInterceptorService = /** @class */ (function () {
    ...
    TokenInterceptorService.prototype.intercept = function (request, next) {
        var authenticationService = this.inj.get(app_security_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]);
...
module.exports = "  <h3>Shopping Cart</h3>\n  <button class=\"btn btn-primary\" (click)=\"reset()\">reset</button>\n  <!-- <ul *ngFor=\"let c of computerParts\" class=\"list-group col-md-10\">\n    <li class=\"list-group-item\"> </li>\n  </ul> -->\n  <table class=\"table table-striped table-sm\">\n    <tr>\n      <th>name</th>\n      <th>action</th>\n    </tr>\n    <tr *ngFor=\"let c of computerParts\">\n      <td>{{c.computerPart.name}}</td>\n      <td><button class=\"btn btn-warning\" (click)=\"remove(c.id)\">delete</button></td>\n    </tr>\n"
...
var ShoppingCartComponent = /** @class */ (function () {
    function ShoppingCartComponent(http, authenticationService) {
        this.http = http;
        this.authenticationService = authenticationService;
        this.changelog = [];
    ...
    ShoppingCartComponent.prototype.ngOnChanges = function (changes) {
        ...
        for (var propName in changes) {
            ...
            var changeLog = propName + ": changed from " + from + " to " + to + " ";
    ...
    ShoppingCartComponent.prototype.loadData = function () {
        var _this = this;
        this.http.get('api/shop').subscribe(function (data) {
            _this.computerParts = data;
        });
    };
    ShoppingCartComponent.prototype.save = function () {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ "Content-Type": "application/json" });
        this.http.post('api/shop', JSON.stringify(this.computerPart), { headers: headers }).subscribe(function (data) {
            _this.loadData();
        });
    ...
    ShoppingCartComponent.prototype.remove = function (id) {
        var _this = this;
        this.http.delete("api/shop/" + id).subscribe(function () {
            _this.loadData();
        });
    };
    __decorate([
    ...
    ], ShoppingCartComponent.prototype, "computerPart", void 0);
...
module.exports = __webpack_require__(/*! /home/klostur/web/projekat_56/client/src/main.ts */"./src/main.ts");
